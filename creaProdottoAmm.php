...
if(strlen($modello)<1){
 ...
 foreach($t as $tipi_da_visualizzare){
  $tipi_accessori.= '<option value="'.$tipi_da_visualizzare['tipo'].'">';
    ...
    <label for="produttoreAmmCreaA1">Produttore</label>
...
<label for="tipologiaAmmCreaA1">Tipologia</label> 
