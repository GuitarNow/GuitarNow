...
$web_page = str_replace('<title_page/>', "Prodotti Amministrazione", $web_page);

$web_page = str_replace('<breadcrumbs_to_insert/>', "Prodotti/Chitarre - Amministrazione", $web_page);
...
<li id="btn_accessori" class="link" role="none"><a href="ProdottiAmm.php?categoria=accessori" role="menuitem">Accessori</a></li>
    ';
}elseif($categoria == "accessori"){
    $menu_prodotto = '
    <li id="btn_chitarre" class="link" role="none"><a href="ProdottiAmm.php?categoria=chitarre" role="menuitem">Chitarre</a></li> 
...
{
    $contenuto_pagina.= '<a class="a_page_prodotti" href="GestisciProdottoAmm.php?prodotto='.$prodotti['codice_prodotto'].'&tipo='.$categoria.'"><li class="chitarre_prodotti">
