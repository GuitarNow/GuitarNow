...
--
-- Host: 127.0.0.1
-- Creato il: Giu 22, 2021 alle 20:23
...
(9, 'Pacifica 212 VFM', 'Yamaha', 'Si presenta con accattivanti figure in acero sulla parte superiore del corpo e sulla paletta, la Pacifica 212VFM ̬ una variante della Pacifica 112V sviluppato appositamente. Questo modello offre <span lang="en" >pickup</span> in Alnico e la funzione <span lang="en" >coil-tap</span>, mentre il suo bellissimo corpo in acero fiammato offre una presenza senza precedenti con il suo <span lang="en" >look</span> di alta classe. Questo modello ha anche figure in acero sulla sua paletta con una finitura corrispondente. Sono disponibili tre colori trasparenti per mettere in evidenza i disegni di alta classe.', 330.00),
